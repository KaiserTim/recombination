...
dataset='in512'
#feature_model='swav-np16'  # swav-np16 or swav-np64 or dinov2
...
for np in 16 ; do
  for feature_model in "dinov2-np16" "swav-np16" "lpips-vgg-np${np}" ; do  # "dinov2-np16" "swav-np16" "lpips-vgg-np${np}"
